#!/usr/bin/env python3
"""
Test script for JAUNDICE robot hardware (LED Expressions Version)
Run this to test individual LED expressions before using voice commands
"""
...
def test_robot():
    """Test all robot LED expressions"""
    ...
    try:
        ...
        print("🤖 Testing JAUNDICE Robot LED Expressions...")
        
        # Test commands
        commands = [
            ('u', 'Activate LEDs'),
            ('h', 'Thinking Expression'),
            ('p', 'Happy Expression'),
            ('U', 'Angry Expression'),
            ('s', 'Sad Expression'),
